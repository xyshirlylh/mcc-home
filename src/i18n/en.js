export default {
  ...
  "about": "In response to the China’s Going Global Strategy, we entered the Singapore market in 1992. Over the past twenty years, MCC Singapore has undergone many trials and tribulations.Progressing from a small company to the big enterprise of today, we have become stronger and have also steadily reached new heights.Our business has undergone several transformations and upgrades, from the initial labour subcontracting to professional subcontracting, general contracting, and real estate development.Currently, we are promoting the transformation and upgrade from a real estate developer to an integrated urban operator, diversifying and digitalizing our business.We are striving to realize our vision of being an efficient, innovative, and the world’s leading integrated urban operator.",
  ...
  "news": {
    ...
    "16": {
      ...
      "date": "May 28, 2021",
      "contentCN": "",
      "content": "On 28 May 2021, MCC Singapore was awarded the design and construction contract for Changi East Depot. A project worth S$1.05 billion awarded by the Land Transport Authority (LTA) of Singapore, the Changi East Depot designed and constructed by MCC Singapore, with China Jingye Engineering Corporation Limited (Singapore Branch) as the contractor, will be the second LTA-related project undertaken by the company since the Bedok South Station and Tunnels project for the Thomson-East Coast Line (TEL). This project is a significant milestone for MCC Singapore’s development in the local infrastructure industry and fully reflects the company’s capabilities in project design, construction, and project management.\n\nThe 57-hectare Changi East Depot, located near Changi Exhibition Centre, will house the Operations Control Centre (OCC) and provide stabling and maintenance facilities for 70 Cross Island Line (CRL) trains. Construction works for the Changi East Depot commences in 2021 with completion slated for 2030.\n\nThe Cross Island Line (CRL) is Singapore’s eighth MRT line and will be the longest fully underground line at more than 50 kilometres long. CRL Phase 1, covering 29 kilometres long with 12 MRT stations, is scheduled to be completed by 2030.\n\n"
    },

    "15": {
      "id": "15",
      "photocount": 3,
      "title": "MCC Singapore Celebrates Chinese New Year“A Letter Home” Wins First Prize in CEA Virtual New Year’s Gala",

      "date": "Feb 10, 2021",
      "contentCN": "",
      "content": "On the evening of 10 February 2021, 5 pm, the virtual Chinese New Year’s Gala hosted by the China Enterprises Association (CEA) of Singapore officially commenced, and as one of the important sub venues, MCC Singapore was present on time and participated remotely. Due to the pandemic, many Chinese people overseas were unable to return to their home towns and countries for Chinese New Year this year. CEA was concerned about the employees of Chinese enterprises in Singapore and held a virtual gala to welcome the New Year together. Among the various Chinese enterprises, “A Letter Home” and “The Mighty Landscape of Mount Tai” presented by MCC Singapore won the first and third prize respectively.\n\nAs the festive season was approaching, considering that employees from China and Malaysia had to spend New Year’s Eve in Singapore, MCC Singapore hung lanterns, put up Chinese New Year banners, and decorated the office area with all kinds of New Year decorations, as well as distributed condolence gifts to all the employees, creating a festive atmosphere in the office. Knowing that CEA will soon hold a virtual gala and request performances from employees and family members of Chinese enterprises in Singapore, MCC Singapore actively organised and participated in the event, presenting “A Letter Home” and “The Mighty Landscape of Mount Tai.” Among them, “A Letter Home” was adapted from a popular folk song of the same name, which was sung by eight employees of MCC Singapore to send a sincere holiday greeting to their families on behalf of all employees who are abroad and unable to return home for Chinese New Year, and together, made a wish to “definitely return home for the next Spring Festival.”  With moving lyrics and heartfelt production, the performance was highly praised by the judges and won the first prize. “The Mighty Landscape of Mount Tai,” on the other hand, is a cultural presentation, painted by Zhai Xi Guang, father of MCC employee Zhai Dong, and is presented in video form. Mr Zhai said that Mount Tai is the foremost of the five great mountains of China, symbolising the strength and self-confidence of the Chinese culture, and he hoped that all colleagues of MCC Singapore would inherit this spirit and virtue even if they are overseas. With the exquisite painting and profound meaning, the work was also appreciated by the jury and won the third prize.\n\nOn the evening of the gala event, Mr Cheng Jun, President of CEA, delivered a speech to kick off the exciting festive celebration. The two award-winning presentations of MCC Singapore and the programs presented by each company were broadcasted one after another, showcasing the talents of the employees and family members of Chinese enterprises as we celebrate the Chinese New Year together. Towards the end of the event, the host connected with the MCC Singapore sub venue virtually as Mr Tan Zhiyong, Mr Chen Xiaodong, and eight other personnel come together to wish all the Chinese enterprises in Singapore a flourishing business, good health to people in China and Singapore, as well as a prosperous Chinese New Year to all!"
    },

    "14": {
      "id": "14",
      "photocount": 3,
      "title": "Remote Video Inspection by Minister-Counselor Zhang Xumin of the Chinese Embassy in Singapore MCC Singapore’s Preventive Measures for COVID - 19 and Resumption of Work",

      "date": "Dec 9, 2020",
      "contentCN": "",
      "content": "At 9.30 am on 9 December 2020, Minister-Counselor Zhang Xumin of the Chinese Embassy in Singapore connected to the sites of MCC Singapore, Mandai Rainforest Park (North) project, and the Normanton Park condominium project through video means to inspect and guide MCC Singapore in its preventive measures for COVID-19 and resumption of work.\n\nAt the beginning of the meeting, Mr Tan Zhiyong, Director and Chief Executive Officer (CEO) of MCC Singapore, expressed his gratitude to Mr Zhang and the Embassy for the care and attention given to MCC Singapore before moving on to report on the various measures taken by the company since the pandemic and the results achieved, the arrangements and progress regarding the company’s resumption of work and production, as well as the current situation regarding compliance management.\n\nSince the appearance of the first confirmed case in Singapore, MCC Singapore has always prioritised the safety of its personnel, strengthened personnel management, and took the preventive measures for COVID-19 seriously. MCC Singapore has continuously learnt from China’s experience in the fight against the pandemic, maintaining close cooperation with the Embassy, the Group, and MCC CRIBC, as well as conscientiously demonstrating the spirit of pandemic prevention, following the regulations and instructions to block pandemic transmissions and minimise the risk of the pandemic. While actively fighting against the pandemic, MCC Singapore held fast to its business operations and signed six major projects consecutively under the pandemic. During the two-month Circuit Breaker period, MCC Singapore’s business continued to develop steadily, the off-site work of various projects progressed smoothly, and the company made full use of the work-from-home period to turn the crisis into an opportunity, improving the overall management of the company and systematically sorting out various tasks. In mid-June, Singapore entered the second phase of the reopening, and MCC Singapore also gradually resumed work and production in strict accordance with the local government requirements. A total of eight projects are currently under construction in Singapore, including the newly signed project this year, the Mandai Rainforest Park project, as well as the Short Street Hotel project.\n\nFollowing the report by Mr Tan Zhiyong, Wang Bin, the representative of the Normanton Park condominium project, and Xu Yingjie, the representative of the Mandai Rainforest Park project, both reported the actual situation of the resumption of work and production to Minister-Counselor Zhang from their respective project site, including personnel management, the zoning of the site, the environment of the workers’ dormitory on site, etc., showing an exemplar of a site that combines both safety and preventive measures for COVID-19.\n\nAfter listening to the overall report of MCC Singapore, Minister-Counselor Zhang verified the various details, during which he emphasised that the preventive measures for COVID-19 should be updated promptly according to the changes of the pandemic situation and that the personnel management should be refined. For the site safety system, it should be constantly improved to be more specific and detailed according to the situation of the site and pandemic, as well as taking care to manage both the physical and mental health of workers. In addition, the company should also cooperate with the local government to prepare for long-term pandemic prevention in the face of the new normal. In this regard, Mr Tan Zhiyong said the company will continue to put in effort to improve the workers’ quality of life, take care of every worker, and complete every project.\n\nWhen it comes to the workers’ arrangement, Minister-Counselor Zhang was particularly concerned for the 94 Chinese workers in MCC Singapore, and Mr Tan Zhiyong responded that most of them are now living in the company’s self-managed Kranji dormitory, project site dormitory, and self-leased housing, while a few are temporarily living in government dormitories due to workplace restrictions and will be transferred to self-managed dormitories in the future. In fact, the living conditions of all workers in MCC Singapore have now been upgraded and the project site dormitories have started using two-room arrangements with en-suite bathrooms. In addition, MCC Singapore also provides internet access for all workers to meet their communication and recreational needs after work.\n\nTowards the end of the meeting, Minister-Counselor Zhang summarised the remote video inspection. He said that MCC Singapore is one of the larger enterprises with more projects in the construction category of Chinese enterprises in Singapore and is one of the focus for the Embassy’s concern. He also expressed his anticipation for the pandemic situation to be under control as soon as possible when he can personally visit MCC Singapore and its project sites after the relaxing of preventive measures.\n\nFinally, on behalf of China’s Ambassador to Singapore Hong Xiaoyong, the Embassy, and the Embassy’s Party Committee, Minister-Counselor Zhang sent deep condolences to all the staff of MCC Singapore and fully affirmed the achievements of MCC Singapore in pandemic prevention and control as well as business development in the past year. He also hopes that MCC Singapore would continue its efforts to refine its safe production under the pandemic’s new normal."
    },

    "13": {
      "id": "13",
      "photocount": 3,
      "title": "MCC Singapore Wins Bid Singapore Yishun Avenue 9 Executive Condominium EPC Project",

      "date": "Nov 23, 2020",
      "contentCN": "",
      "content": "On 23 November 2020, MCC Singapore was once again greeted with good news as it won the bid for Singapore Yishun Avenue 9 Executive Condominium EPC Project. The contract value is worth S$158,531,000.00, which is about RMB 790 million. Winning the bid this time fully shows the owner’s recognition and affirmation of MCC Singapore’s strength in EPC contracting for Singapore projects. The project is located in the north of Singapore with a building area of approximately 60,240 square meters, a site area of 21,514 square meters and a plot ratio of 2.80. This 99-year leasehold site has a building height of 56 meters above sea level, a project construction cycle of no more than five years, and can potentially yield 708 residential units.\n\nThe project is located 1.2 km from Yishun MRT Station that is just a 7-minute car ride away. It is also conveniently located near the Seletar Expressway (SLE), Bukit Timah Expressway (BKE), Kranji Expressway (KJE), Pan Island Expressway (PIE), as well as the North-South Expressway (NSE) which is expected to be completed in 2026. The project is close to two shopping malls in Yishun District: Junction Nine and Northpoint City, and there are several schools in the vicinity, such as Xishan Primary School, Chongfu School, Yishun Town Secondary School, and GEMS World Academy (Singapore). In addition, it is only a 10-minute drive to Khoo Teck Phuat Hospital and Yishun Community Hospital, all of which enable the project to meet the needs of residents in all aspects of life. Moreover, the Khatib Bongsu Nature Park located just opposite the project site is one of the important landmarks in the Yishun District and is an ideal place for nearby residents to enjoy outdoor activities."
    },

    "12": {
      "id": "12",
      "photocount": 3,
      "title": "MCC Singapore Wins Bid Singapore Tanah Merah Kechil Link Private Residential Site",

      "date": "Oct 29, 2020",
      "contentCN": "",
      "content": "On 29 October 2020, MCC Singapore was greeted with a report of success as it won the bid for the private residential site at Tanah Merah Kechil Link in eastern Singapore with the highest bid of S$248.99 million. The site is located right next to Tanah Merah MRT Interchange Station and is near the Singapore Expo as well as Singapore Changi Airport. With a plot ratio of 2.8 and a total floor area of up to 24,864 square meters, the 99-year leasehold site is slated for residential with commercial use on the first storey and can potentially yield 265 condo units.\n\nSince the opening of the bidding process in May 2020, the site has attracted 15 parties to participate in the bidding, marking the largest number of participating bidders with similar bids since the new round of cooling measures in Singapore from August 2018. Winning the bid this time has fully demonstrated MCC Singapore’s precise understanding and judgement of the local market trends. MCC Singapore plans to develop a creative and innovative space for both the community and businesses in the site, as well as create a smart and green living environment, providing Singapore residents with a better choice of private housing and leisure experience, transforming the lives of future owners."
    },
