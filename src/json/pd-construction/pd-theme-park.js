export default {
  "Maritime Experiential Museum": {
    ...
    completionYear: "",
    totalUnits: "",
    desc: "The Maritime Experiential Museum is a complex geotechnical engineering project involving long-span reinforced concrete structures and large steel structures. New technologies were used to integrate the application and development of materials like rocks, concrete structures and steel structures. With a contract value of S$19,400,688.80, the project commenced in 2009 and was completed in 2010.",
    website:"",
    location: {lat: "", lng: ""},
    images: [
  ...
  "Universal Studios Singapore": {
    ...
    completionYear: "",
    totalUnits: "",
    desc: `Universal Studios Singapore (USS) is the world’s fourth Universal Studios and the first in Southeast Asia. This S$800 million worth contract is the largest civil construction project awarded to a Chinese contractor in Singapore and is also the first large-scale overseas integrated theme park project undertaken by a Chinese enterprise.
